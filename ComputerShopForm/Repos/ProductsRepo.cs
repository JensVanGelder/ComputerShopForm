    ...
    public class ProductsRepo : IProductsRepo
    {
        ...
        public List<IProduct> CreateProductList()
        {
            ...
            var products = new List<IProduct>
            {
                ...
                new GamingPc ("ACER Predator Orion 5000 (615S I910-14GLR)", 3299, "https://i.imgur.com/UPlXOcf.png", "High-end Gaming workhorse.", 4, 32,"ASROCK MAXIMUS Gaming Rev.7","1TB HDD + SSD 512GB","Intel Core i9-10900K", "ACER supplied Hard gamecore PSU","NVIDIA GeForce RTX 2080 Ti", Performance.Extreme, true),
                ...
                new Laptop ("MEDION ERAZER", 999,"https://i.imgur.com/5VmrAef.png","Unleash your inner gamer.",4,16,"MED10300H", "WD 512GB SSD","Intel Core i5","Standard Laptop PSU",15,"TN No-glare screen",1540),
                ...
                new Laptop("Lenovo Ideapad 120S - 14",284,"https://i.imgur.com/RsZke7A.png","Entry-level portable computer",24,2,"Lenovo LE254 60NB00M0","Samsung SSD 128GB","Intel Celeron N3350","Lenovo supplied Laptop PSU",14,"IPS No-glare screen",1440),
                new Workstation("Acer Veriton mini N4670GT",1699,"https://i.imgur.com/ntXhOAN.png","With the Acer Veriton Mini Workstation N4670GT - DT.VU1EH.002, you don't have to choose between powerful and compact.",2,32,"Acer Veriton X275 Desktop Motherboard","Samsung EVO SSD 512GB x2","Intel Core i9","1500W Acer PSU","RAID-1"),
