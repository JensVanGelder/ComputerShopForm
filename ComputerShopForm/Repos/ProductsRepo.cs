...
namespace ComputerShopForm
{
    public class ProductsRepo : IProductsRepo
    {
        ...
        public List<IProduct> CreateProductList()
        {
            ...
            {
                new Laptop ("HP Oblivion III", 1499,"http://placekitten.com/200/300","A good laptop!",0,8,"AsusRock MAXIMUS Portable", "Seagate LKXII","Intel i5 gen2","HP supplied Laptop PSU",17,"No-glare screen",1245),
